...
<body>
<form action="./joinTest" style="border:1px solid #ccc" method="post">
    <div class="container">
      <h1>회원가입</h1>
      <p>아래의 항목을 기입해 주세요.</p>
      <hr>
      ...
      <input type="text" placeholder="Input Id" name="id" id="id">
	  <br>
      <label for="pwd"><b>비밀번호</b></label>
      <input type="password" placeholder="Input Password" name="pw" id="pw">
  	  <br>
      ...
      <input type="text" placeholder="Input phoneNumber" name="phoneNumber" id="phoneNumber">
      <br>
      <fieldset>
        <legend>성별</legend>
