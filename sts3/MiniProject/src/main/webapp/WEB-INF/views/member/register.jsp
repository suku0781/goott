...
// 					debugger
	...
	function validUserId(){
		...
		if(userId.length > 2 && userId.length < 9){
			...
			let obj = {};
			obj.userId = userId;
			isuserIdValidChkYn = getData("dulpUserId", "GET", obj, "json") ? false : true; // 아이디 중복검사 해서 중복이 아니면 true를 리턴하기위해서 반대로 설정함.
...
// 			return type == "sendCode" ? true : getData("dulpUserEmail", "GET", obj, "json");
			return true;
		} else {
